    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="row text-center">
                    ...
                    <div class="box-card col-sm-12 col-md-6 mb-3">
                        <div class="content bg-white">
                            ...
                            <a class="btn btn-basic mb-3" href="<?php echo $value['url_boton']; ?>">
                                <?php echo $value['texto_boton']; ?>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-md-4 px-0  box-container banner">
                <div class="box-fluid">
                    <img class="box-fluid-image animated fadeIn" src="<?php echo esc_url($especializaciones['image']); ?>"
                        alt="profile" />
                </div>
            </div>
